...
// La extracción de nombre corto/color/composición vive en lib/telas.js
// (compartida con /api/odoo/articulos, que sugiere los productos de las OC).
...
export async function GET(req) {
  ...
  try {
    ...
    const detalles = await enriquecerProductos(productos);
